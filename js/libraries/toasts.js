async function makeToast(content, type) {
    ...
    let icon;
    if (type === "success")
        icon = `<svg class="w-[20px]" fill="white" id="icon-check" xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
    <path
        d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" />
</svg>`;
    else if (type === "warning")
        icon = `<svg class="w-[20px]" fill="white" id="icon-exclamation" xmlns="http://www.w3.org/2000/svg"
    ...
    <path
        ...
        icon = `<svg class="w-[20px]" fill="white" id="icon-x-mark" xmlns="http://www.w3.org/2000/svg"
    ...
    Toastify({
        text: `<div class="flex flex-row gap-2 items-center justify-start"> 
            <span class="p-2 px-4 rounded-md w-fit h-fit" style="background-color: ${bgColor.darken(
                0.2
            )};">${icon}</span>
